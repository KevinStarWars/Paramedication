...
public class BloodOperations {
    ...
    private BloodRecord cursorToBloodRecord(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            double leukocyteMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_LEUKOCYTE_MIN)));
            double leukocyteMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_LEUKOCYTE_MAX)));
            double erythrocyteMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_ERYTHROCYTE_MIN)));
            double erythrocyteMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_ERYTHROCYTE_MAX)));
            double hemoglobinMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_HEMOGLOBIN_MIN)));
            double hemoglobinMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_HEMOGLOBIN_MAX)));
            double hematocritMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_HEMATOCRIT_MIN)));
            double hematocritMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_HEMATOCRIT_MAX)));
            double mcvMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MCV_MIN)));
            double mcvMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MCV_MAX)));
            double mchMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MCH_MIN)));
            double mchMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MCH_MAX)));
            double mchcMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MCHC_MIN)));
            double mchcMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MCHC_MAX)));
            double plateletMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_PLATELET_MIN)));
            double plateletMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_PLATELET_MAX)));
            double reticulocytesMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_RETICULOCYTES_MIN)));
            double reticulocytesMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_RETICULOCYTES_MAX)));
            double mpvMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MPV_MIN)));
            double mpvMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_MPV_MAX)));
            double rdwMin = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_RDW_MIN)));
            double rdwMax = Double.parseDouble(cursor.getString(cursor.getColumnIndex(BloodTableContract.BloodTableEntry.COLUMN_RDW_MAX)));
